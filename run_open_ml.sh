...
python -u synthcity_bench_missing_goggle_files.py --data_type=cat --task_type=regression  --model=ctgan
...
python -u synthcity_bench_missing_goggle_files.py --data_type=num --task_type=regression  --model=ctgan
