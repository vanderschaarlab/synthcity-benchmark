...
# df = datasets.functions.get_dataset(61)
# X, Y, categorical_indicator, attribute_names = df.get_data()
#
# print(X.head())
...
def run_open_ml(data_type='num', task_type='regression'):
    ...
    task_df = tasks.list_tasks(task_type=oml_task_type, output_format='dataframe')[['tid', 'did']]
